...
export default function AddGameScreen({ navigation }: any) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 60 }}>
      ...
      <PixelInput label="PRICE"       value={price}       onChangeText={setPrice}       />
      ...
      {/* ══ BOTONES ══ */}
      <TouchableOpacity activeOpacity={1} style={styles.saveBtn} onPress={handleAddGame}>
